...
final class ListCommandTest extends KernelTestCase
{
    ...
    public function execute(): void
    {
        $this->executeConsoleCommand('zenstruck:twig-service:list')
            ...
            ->assertOutputContains('strlen             strlen                                                      (throw)')
            ->assertOutputContains('someMethod1        Zenstruck\Twig\Tests\Fixture\SomeClass::someMethod1()       (throw)')
            ->assertOutputContains('router             Symfony\Bundle\FrameworkBundle\Routing\Router->generate()   "error!"')
            ->assertOutputContains('method1            Zenstruck\Twig\Tests\Fixture\ServiceC->method1()            (throw)')
            ->assertOutputContains('error2             App\error2                                                  null')
